...
class ProductController {
  ...
  static Future<ProductsResponseModel> getProductByLocationResponse({
    ...
    try {
      ...
      var response = await dio.Dio().get(
        "${AppApiUrlController.appApiUrlController()}/products?governorate=${locationId}",
        options: dio.Options(
          headers: <String,String>{
            'Accept': 'application/json',
            'Content-Type': 'application/json',
  ...
  static Future<ProductsResponseModel> getProductByCategoryLocationResponse({
    required String locationId,
    required String categoryId,
    required Function onSuccess,
    required Function onFail,
    ...
    try {
      ...
      var response = await dio.Dio().get(
        "${AppApiUrlController.appApiUrlController()}/products?governorate=${locationId}&category=${categoryId}",
        options: dio.Options(
          headers: <String,String>{
            'Accept': 'application/json',
            'Content-Type': 'application/json',
  ...
  static Future<ProductsResponseModel> getProductByStoreResponse({
