    ...
    if(MediaQuery.sizeOf(context).height > 1000) {
      ...
      return Obx(()=>SafeArea(
        child: Container(
          ...
          RefreshIndicator(
            onRefresh: () async {
              Get.off(()=>RestaurantDetailsScreen(storeId: storeId),duration: Duration(milliseconds: 300),transition: Transition.fadeIn,preventDuplicates: false);
            },
                                    ...
                                    Expanded(
                                      child: Column(
                                        ...
                                        children: [
                                          ...
                                          singleStoreDetailsResponseModel.value.data?.categories != null ?
                                          Row(
                                            children: List.generate(singleStoreDetailsResponseModel.value.data!.categories!.length, (Index) {
                                              return Container(
                                                alignment: Get.locale.toString() == "en" ? Alignment.centerLeft : Alignment.centerRight,
                                    ...
                                    builder: (context) {
                                      return Padding(
                                        ...
                                        child: Container(
                                          ...
                                          child: singleStoreDetailsResponseModel.value.data?.categories != null ?
                                          CustomScrollView(
                                            slivers: [
                                              SliverToBoxAdapter(
                                                child: Column(
