...
class TermsAndConditionsScreenWidget extends GetxController {
  ...
  Rx<SettingDataResponseModel> settingDataResponseModel = SettingDataResponseModel().obs;
  BuildContext context;
  TermsAndConditionsScreenWidget({required this.context});
  ...
  void onInit() {
    ...
    Future.delayed(Duration(seconds: 1),() async {
      await SettingController.getSettingResponse(
        onSuccess: (e) async {
          isLoading.value = false;
          await SettingController.checkLocalProfileResponse().then((value) {
            if(value?.data != null) {
                  ...
                  children: [
                    ...
                    Padding(
                      ...
                      child: Container(
                        ...
                        child:  HtmlWidget(
                          "${settingDataResponseModel.value.data?.first.termsConditions}",
