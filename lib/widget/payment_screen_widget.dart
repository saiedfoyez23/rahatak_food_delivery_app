...
class PaymentScreenWidget extends GetxController {
  ...
  void onInit() {
    ...
    super.onInit();
    Future.delayed(Duration(seconds: 1),() async {
      await CartController.checkLocalCartResponse().then((value) {
        if(value?.data != null) {
  ...
  Widget paymentScreenWidget({required BuildContext context,required String addressId,required Map<String,dynamic> data}) {
        ...
        child: Column(
          children: [
                                                  ...
                                                  Row(
                                                    ...
                                                    children: [
                                                      ...
                                                      Container(
                                                        alignment: Alignment.centerLeft,
                                                        child: Text(
                                                          "${"Quantity:".tr} ${cartResponseModel.value.data?[index].quantity}".tr,
                                                          textAlign: TextAlign.start,
                                                          style: GoogleFonts.tajawal(
                                                            fontWeight: FontWeight.w500,
                                                            fontStyle: FontStyle.normal,
            ...
            Container(
              ...
              child: isLoading.value == false ? Container(
                height: 48.hm(context),
                width: 358.wm(context),
                decoration: BoxDecoration(
                  color: ColorUtils.blue192,
